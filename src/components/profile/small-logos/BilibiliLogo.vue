...
<template>
    <svg class="small-icons" @click="jumpto()" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="34" height="34"
        viewBox="0 0 48 48">
        <path fill="#FB7299"
        ...
        <rect width="2.75" height="7.075" x="30.625" y="18.463" fill="#FB7299" transform="rotate(-71.567 32.001 22)">
        </rect>
        <rect width="7.075" height="2.75" x="14.463" y="20.625" fill="#FB7299"
